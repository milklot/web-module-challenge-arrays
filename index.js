...
let array2 = addFlavor(originalFlavors, "Rainbow Sherbert");
console.log(array2);
...
function removeFlavorByName(array, string) {
    let target = array.indexOf(string);
...
function copy(ogArray, newArray) {
    let result = [];
    newArray = [...ogArray];
    result = newArray;
    return result;
...
let eli = [];
let answer = copy(originalFlavors, eli);
...
let lastArray = filterByWord(originalFlavors, 'Chocolate');
...
let selection = getRandomFlavors(originalFlavors, seasonalFlavors, regionalFlavors, newFlavors);
